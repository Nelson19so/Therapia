export default function Resource_Library() {
  ...
  return (
    <main>
      <section className="h-[50%] gap-20 flex justify-center pt-10 pb-10" >
        ...
        {/* image page */}
        <div className="">
          <img src="/images/therapy session metting.webp" alt="" />
        </div>
      </section>
      ...
      <section className="h-[500px] pt-10 pb-10 ">
        <div className="mx-auto flex justify-center gap-10 flex-col ">
          ...
          <div className="mt-6 grid mr-[10%] ml-[10%] gap-5 grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
            <div className="flex justify-center shadow-[0_0_10px_var(--neutral-base)] gap-5 rounded-2xl flex-col  h-90 items-center">
              ...
              <div className="text-1xl text-center mr-auto px-5 ml-auto ">Navigate a diverse collection of mental<br /> health materials carefully selected to<br /> meet your needs.</div>
            </div>
            <div className="flex justify-center shadow-[0_0_10px_var(--neutral-base)] gap-5 rounded-2xl flex-col  h-90 items-center">
              ...
              <div className="text-1xl text-center mr-auto px-5 ml-auto ">Quickly find articles and guides that <br /> resonate with your unique journey using<br /> our intuitive search function.</div>
            </div>
            <div className="flex justify-center shadow-[0_0_10px_var(--neutral-base)] gap-5 rounded-2xl flex-col  h-90 items-center">
              ...
              <div className="text-1xl text-center mr-auto px-5 ml-auto ">Use our filter sidebar to refine your<br /> search based on specific interests,<br /> making discovery effortless.</div>
            </div>
            <div className="flex justify-center shadow-[0_0_10px_var(--neutral-base)] gap-5 rounded-2xl flex-col  h-90 items-center">
              ...
              <div className="text-1xl text-center mr-auto px-5 ml-auto ">Easily save and retrieve essential<br /> resources that make a significant<br /> impact on your well-being.</div>
            </div>
          </div>
        </div>
      </section >
      ...
      <section className="h-[50%] flex justify-center gap-20 pt-10 pb-10" >
        <div className="">
          <img src="/images/woman walking out of therapy room happy.webp" alt="" />
        </div>
        <div className=" max-w-2xl px-4 pt-10 pb-16 flex  justify-center ">
          <div className="flex flex-col justify-center gap-5 items-center ">
            ...
            <div className="grid grid-rows-[40px] gap-5 mt-10 grid-cols-[40px_auto]" >
              <div className="rounded-full">
                <img src="/images/profile of therapist.webp" className="rounded-full h-[100%] w-auto" alt="" />
              </div>
      ...
      <section className="h-[50%] flex gap-20 justify-center pt-10 pb-10" >
        <div className=" max-w-3xl px-4  flex justify-center ">
          <div className="flex flex-col h-[100%] justify-center items-center  gap-5">
            ...
            <div className="grid grid-rows-[40px] gap-5 mt-10 grid-cols-[40px_auto]" >
              <div className="rounded-full">
                <img src="/images/transformation therapist profile.webp" className="rounded-full" alt="" />
              </div>
              <div className="text-1xl tracking-tight text-gray-900">
        ...
        <div className="rounded-xl">
          <img src="/images/helping client brain.webp" className="h-[100%] rounded-xl" alt="" />
        </div>
      </section>

      <section className="h-[600px]  flex justify-center pt-10 pb-10 ">
        <div className="w-[100%] relative  h-[400px] rounded-[20px]  gap-5  mr-[20%] ml-[20%]  bg-[var(--primary)] flex justify-center items-center flex-col" >
          ...
          <div className="text-xl  mx-[10%] text-center tracking-tight text-gray-900" >Explore invaluable resources tailored for your journey, organized in a soothing grid layout that ensures you find the support you need at your fingertips.</div>


          <div className="absolute top-[70%] z-[10]  mt-6 grid mr-auto ml-auto gap-5 grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
            <div className="flex   h-[1fr] bg-[var(--background-base)] justify-center  shadow-[0_0_10px_var(--neutral-base)] px-[20px] py-[15px] gap-5 rounded-[20px] flex-col   items-center">
              <div className="bg-[var(--primary)] flex justify-center items-center w-17 rounded-full p-5 text-2xl p-auto  font-bold">1</div>
